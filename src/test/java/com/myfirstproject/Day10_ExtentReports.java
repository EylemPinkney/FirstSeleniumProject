...
//        And select the ‘United Kingdom’ from the suggestions
            //TAKE SCREENSHOT
            extentTest.pass("Selecting the United Kingdom opttion");
            takeScreenshotOfTheEntirePage();
...
//        And click on submit button
            //TAKE SCREENSHOT
            takeScreenshotOfTheEntirePage();
            extentTest.pass("CLICKING SUBMIT BUTTON");
...
//        TAKING THE SCREENSHOT OF THE RESULT ELEMENT
            extentTest.pass("Taking the screnshot of RESULT element");
            WebElement result = driver.findElement(By.id("result"));
            takeScreenshotOfThisElement(result);

            extentTest.pass("Asserting the result");
