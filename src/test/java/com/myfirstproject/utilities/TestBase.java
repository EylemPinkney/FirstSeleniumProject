...
//        generate the report
    ...
    public void takeScreenshotOfTheEntirePage() throws IOException {
        ...
        //1. Way
//        1. TakeScreenShot class with getScreenShotAs method to capture the screenshot => Taking a screenshot
        File image = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);//we choose File for JUnit.
...
//        3. Save the image in the path(we just created) as a file
...
//        FileUtils.copyFile(FILE,FILE PATH); COPY FILE TO THAT FILE PATH
       ...
       // FileUtils.copyFile(((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE),
        // new File(System.getProperty("user.dir")+"/test-output/Screenshots/"+now+"image.png"));
