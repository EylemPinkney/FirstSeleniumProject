...
public class Day13_ExplicitWait extends TestBase {
    ...
    /*
    Note: for Explicit Wait =>
    WebDriverWait wait = new WebDriverWait(driver,Duration.ofSeconds(10));
    WebElement element = wait.until(ExpectedConditions.visibilityOf( driver.findElement(By.xpath("//div[@id='finish']//h4"))  ));

    1-Waits for the element up to 10 seconds
    2-Returns the WebElement so we dont need to use find element again.
    3-We must use explicit wait for each element that we want to wait for
     */
